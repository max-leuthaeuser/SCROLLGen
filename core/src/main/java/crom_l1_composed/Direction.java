 ...
 * <!-- end-user-doc -->
 * @see crom_l1_composed.Crom_l1_composedPackage#getDirection()
 * @model
 * @generated
 */
public enum Direction implements Enumerator {
	...
	public static Direction get(int value) {
		switch (value) {
			...
			case FIRST_TO_SECOND_VALUE: return FIRST_TO_SECOND;
			case SECOND_TO_FIRST_VALUE: return SECOND_TO_FIRST;
		}
		return null;
	}
