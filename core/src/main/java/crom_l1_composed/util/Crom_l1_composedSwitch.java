 ...
 * @generated
 */
public class Crom_l1_composedSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Crom_l1_composedPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.MODEL_ELEMENT: {
			...
			case Crom_l1_composedPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.RIGID_TYPE: {
				RigidType rigidType = (RigidType)theEObject;
				T result = caseRigidType(rigidType);
				if (result == null) result = caseType(rigidType);
				if (result == null) result = caseModelElement(rigidType);
				if (result == null) result = caseRelationTarget(rigidType);
				if (result == null) result = caseNamedElement(rigidType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.GROUP: {
				Group group = (Group)theEObject;
				T result = caseGroup(group);
				if (result == null) result = caseModelElement(group);
				if (result == null) result = caseModel(group);
				if (result == null) result = caseNamedElement(group);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.PARAMETER: {
			...
			case Crom_l1_composedPackage.OPERATION: {
			...
			case Crom_l1_composedPackage.ATTRIBUTE: {
			...
			case Crom_l1_composedPackage.TYPE: {
				Type type = (Type)theEObject;
				T result = caseType(type);
				if (result == null) result = caseRelationTarget(type);
				if (result == null) result = caseNamedElement(type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.DATA_TYPE: {
				DataType dataType = (DataType)theEObject;
				T result = caseDataType(dataType);
				if (result == null) result = caseRigidType(dataType);
				if (result == null) result = caseType(dataType);
				if (result == null) result = caseModelElement(dataType);
				if (result == null) result = caseRelationTarget(dataType);
				if (result == null) result = caseNamedElement(dataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.NATURAL_TYPE: {
				NaturalType naturalType = (NaturalType)theEObject;
				T result = caseNaturalType(naturalType);
				if (result == null) result = caseRigidType(naturalType);
				if (result == null) result = caseType(naturalType);
				if (result == null) result = caseModelElement(naturalType);
				if (result == null) result = caseRelationTarget(naturalType);
				if (result == null) result = caseNamedElement(naturalType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.COMPARTMENT_TYPE: {
				CompartmentType compartmentType = (CompartmentType)theEObject;
				T result = caseCompartmentType(compartmentType);
				if (result == null) result = caseRigidType(compartmentType);
				if (result == null) result = caseType(compartmentType);
				if (result == null) result = caseModelElement(compartmentType);
				if (result == null) result = caseRelationTarget(compartmentType);
				if (result == null) result = caseNamedElement(compartmentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ANTI_RIGID_TYPE: {
				AntiRigidType antiRigidType = (AntiRigidType)theEObject;
				T result = caseAntiRigidType(antiRigidType);
				if (result == null) result = caseType(antiRigidType);
				if (result == null) result = caseRelationTarget(antiRigidType);
				if (result == null) result = caseNamedElement(antiRigidType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ROLE_TYPE: {
				RoleType roleType = (RoleType)theEObject;
				T result = caseRoleType(roleType);
				if (result == null) result = caseAntiRigidType(roleType);
				if (result == null) result = caseAbstractRole(roleType);
				if (result == null) result = caseType(roleType);
				if (result == null) result = caseRoleGroupElement(roleType);
				if (result == null) result = caseRelationTarget(roleType);
				if (result == null) result = caseNamedElement(roleType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.RELATIONSHIP: {
			...
			case Crom_l1_composedPackage.FULFILLMENT: {
			...
			case Crom_l1_composedPackage.INHERITANCE: {
			...
			case Crom_l1_composedPackage.CONSTRAINT: {
			...
			case Crom_l1_composedPackage.ROLE_CONSTRAINT: {
			...
			case Crom_l1_composedPackage.RELATIONSHIP_CONSTRAINT: {
			...
			case Crom_l1_composedPackage.INTRA_RELATIONSHIP_CONSTRAINT: {
				IntraRelationshipConstraint intraRelationshipConstraint = (IntraRelationshipConstraint)theEObject;
				T result = caseIntraRelationshipConstraint(intraRelationshipConstraint);
				if (result == null) result = caseRelationshipConstraint(intraRelationshipConstraint);
				if (result == null) result = caseConstraint(intraRelationshipConstraint);
				if (result == null) result = caseRelation(intraRelationshipConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.INTER_RELATIONSHIP_CONSTRAINT: {
				InterRelationshipConstraint interRelationshipConstraint = (InterRelationshipConstraint)theEObject;
				T result = caseInterRelationshipConstraint(interRelationshipConstraint);
				if (result == null) result = caseRelationshipConstraint(interRelationshipConstraint);
				if (result == null) result = caseConstraint(interRelationshipConstraint);
				if (result == null) result = caseRelation(interRelationshipConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.COMPLEX_CONSTRAINT: {
			...
			case Crom_l1_composedPackage.DATA_INHERITANCE: {
				DataInheritance dataInheritance = (DataInheritance)theEObject;
				T result = caseDataInheritance(dataInheritance);
				if (result == null) result = caseInheritance(dataInheritance);
				if (result == null) result = caseRelation(dataInheritance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.NATURAL_INHERITANCE: {
				NaturalInheritance naturalInheritance = (NaturalInheritance)theEObject;
				T result = caseNaturalInheritance(naturalInheritance);
				if (result == null) result = caseInheritance(naturalInheritance);
				if (result == null) result = caseRelation(naturalInheritance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.COMPARTMENT_INHERITANCE: {
				...
				if (result == null) result = caseInheritance(compartmentInheritance);
				if (result == null) result = caseRelation(compartmentInheritance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ROLE_INHERITANCE: {
				RoleInheritance roleInheritance = (RoleInheritance)theEObject;
				T result = caseRoleInheritance(roleInheritance);
				if (result == null) result = caseInheritance(roleInheritance);
				if (result == null) result = caseRelation(roleInheritance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.PLACE: {
				Place place = (Place)theEObject;
				T result = casePlace(place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.RELATIONSHIP_IMPLICATION: {
				...
				if (result == null) result = caseInterRelationshipConstraint(relationshipImplication);
				if (result == null) result = caseRelationshipConstraint(relationshipImplication);
				if (result == null) result = caseConstraint(relationshipImplication);
				if (result == null) result = caseRelation(relationshipImplication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.RELATIONSHIP_EXCLUSION: {
				RelationshipExclusion relationshipExclusion = (RelationshipExclusion)theEObject;
				T result = caseRelationshipExclusion(relationshipExclusion);
				if (result == null) result = caseInterRelationshipConstraint(relationshipExclusion);
				if (result == null) result = caseRelationshipConstraint(relationshipExclusion);
				if (result == null) result = caseConstraint(relationshipExclusion);
				if (result == null) result = caseRelation(relationshipExclusion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.RELATION_TARGET: {
				RelationTarget relationTarget = (RelationTarget)theEObject;
				T result = caseRelationTarget(relationTarget);
				if (result == null) result = caseNamedElement(relationTarget);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.IRREFLEXIVE: {
				Irreflexive irreflexive = (Irreflexive)theEObject;
				T result = caseIrreflexive(irreflexive);
				if (result == null) result = caseIntraRelationshipConstraint(irreflexive);
			...
			case Crom_l1_composedPackage.CYCLIC: {
				Cyclic cyclic = (Cyclic)theEObject;
				T result = caseCyclic(cyclic);
				if (result == null) result = caseIntraRelationshipConstraint(cyclic);
				if (result == null) result = caseRelationshipConstraint(cyclic);
				if (result == null) result = caseConstraint(cyclic);
				if (result == null) result = caseRelation(cyclic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.TOTAL: {
				Total total = (Total)theEObject;
				T result = caseTotal(total);
				if (result == null) result = caseIntraRelationshipConstraint(total);
			...
			case Crom_l1_composedPackage.ACYCLIC: {
				Acyclic acyclic = (Acyclic)theEObject;
				T result = caseAcyclic(acyclic);
				if (result == null) result = caseIntraRelationshipConstraint(acyclic);
			...
			case Crom_l1_composedPackage.REFLEXIVE: {
				Reflexive reflexive = (Reflexive)theEObject;
				T result = caseReflexive(reflexive);
				if (result == null) result = caseIntraRelationshipConstraint(reflexive);
				if (result == null) result = caseRelationshipConstraint(reflexive);
				if (result == null) result = caseConstraint(reflexive);
				if (result == null) result = caseRelation(reflexive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ABSTRACT_ROLE: {
				AbstractRole abstractRole = (AbstractRole)theEObject;
				T result = caseAbstractRole(abstractRole);
				if (result == null) result = caseRoleGroupElement(abstractRole);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ROLE_GROUP: {
				RoleGroup roleGroup = (RoleGroup)theEObject;
				T result = caseRoleGroup(roleGroup);
				if (result == null) result = caseAbstractRole(roleGroup);
				if (result == null) result = caseRelationTarget(roleGroup);
				if (result == null) result = caseRoleGroupElement(roleGroup);
				if (result == null) result = caseNamedElement(roleGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ROLE_IMPLICATION: {
			...
			case Crom_l1_composedPackage.ROLE_EQUIVALENCE: {
			...
			case Crom_l1_composedPackage.ROLE_PROHIBITION: {
			...
			case Crom_l1_composedPackage.PART: {
				Part part = (Part)theEObject;
				T result = casePart(part);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.TYPED_ELEMENT: {
			...
			case Crom_l1_composedPackage.PARTHOOD_CONSTRAINT: {
				ParthoodConstraint parthoodConstraint = (ParthoodConstraint)theEObject;
				T result = caseParthoodConstraint(parthoodConstraint);
				if (result == null) result = caseIntraRelationshipConstraint(parthoodConstraint);
				if (result == null) result = caseRelationshipConstraint(parthoodConstraint);
				if (result == null) result = caseConstraint(parthoodConstraint);
				if (result == null) result = caseRelation(parthoodConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ROLE_GROUP_ELEMENT: {
				RoleGroupElement roleGroupElement = (RoleGroupElement)theEObject;
				T result = caseRoleGroupElement(roleGroupElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1_composedPackage.ABSTRACT_ROLE_REF: {
				AbstractRoleRef abstractRoleRef = (AbstractRoleRef)theEObject;
				T result = caseAbstractRoleRef(abstractRoleRef);
				if (result == null) result = caseRoleGroupElement(abstractRoleRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Relationship Exclusion</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Relationship Exclusion</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRelationshipExclusion(RelationshipExclusion object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reflexive</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reflexive</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReflexive(Reflexive object) {
		return null;
	}
